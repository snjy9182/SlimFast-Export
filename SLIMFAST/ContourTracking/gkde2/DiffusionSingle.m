...
hold on;
histfit(log10(ma_all.lfit.a(ma_all.lfit.a>0)), 20,'kernel');
...
filename = strcat(FileName2(1:end-4), '.mat');
save(filename, 'ma_all');
% Analyzing Diffusion Coefficent by Bowian 

filename2 = 'testdata.xlsx';
xlswrite(filename2,log10(ma_all.lfit.a(ma_all.lfit.a>0)),1)
